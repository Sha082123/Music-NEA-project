...
void track_object::open_file(QString &file_path)
{
    ...
    // qInfo() << "Mute:" << track_options.mute;
    // qInfo() << "Solo:" << track_options.solo;
    // qInfo() << "Volume:" << track_options.volume;
    // qInfo() << "Start MS:" << track_options.start_ms;
    // qInfo() << "End MS:" << track_options.end_ms;
    // qInfo() << "Duration:" << track_options.duration;
    // qInfo() << Qt::endl << Qt::endl << Qt::endl;
