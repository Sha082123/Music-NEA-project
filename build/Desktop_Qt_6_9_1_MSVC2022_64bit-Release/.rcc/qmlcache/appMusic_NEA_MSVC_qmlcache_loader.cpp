...
namespace _qt_qml_Music_NEA_MSVC_Main_qml { 
...
namespace _qt_qml_Music_NEA_MSVC_styles_FileButton_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_Music_NEA_MSVC_UI_Display_window_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appMusic_NEA_MSVC)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appMusic_NEA_MSVC))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appMusic_NEA_MSVC)() {
    return 1;
}
